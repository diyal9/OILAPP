...
public abstract class ScanBaseActivity extends Activity {
	public GasStationApplication application;
	public ImageView preservation, mBackImg;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		application = (GasStationApplication) getApplication();
...
//		preservation = (ImageView) findViewById(R.id.general_right_interspace);
